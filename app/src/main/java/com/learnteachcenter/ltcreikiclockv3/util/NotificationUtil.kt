...
import com.learnteachcenter.ltcreikiclockv3.position.list.AppConstants
import com.learnteachcenter.ltcreikiclockv3.position.list.PositionListActivity
import com.learnteachcenter.ltcreikiclockv3.position.list.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        private const val CHANNEL_NAME_TIMER = "Reiki Timer"
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .setContentIntent(
                    getPendingIntentWithStack(
                        context,
                        PositionListActivity::class.java
                    )
                )
